        ...
        if action == 'delete':
            if name:
                try:
                    ...
                    brand.delete()
                    print(f"Brand {name} deleted")
                except Brands.DoesNotExist:
                    print(f"Row {i+1}: Brand '{name}' not found")
            else:
            ...
            if name:
                try:
                    ...
                    brand.save()
                    print(f"Brand {name} updated")
                except Brands.DoesNotExist:
                    print(f"Row {i+1}: Brand '{name}' not found for update")
            else:
            ...
            if name:
                try:
                    # Check if exists
                    brand = Brands.objects.get(name=name)
                    print(f"Brand {name} already exists, skipping create")
                except Brands.DoesNotExist:
                    # Create it
