...
'''
for i in range(len(ProductAccessories.objects.all())):
    if ProductAccessories.objects.all()[i].product.name[:5] == 'EXACT':
        print(f"Product Accessories: {ProductAccessories.objects.all()[i].product.id} {ProductAccessories.objects.all()[i].product.name} {ProductAccessories.objects.all()[i].name} {ProductAccessories.objects.all()[i].quantity}")
