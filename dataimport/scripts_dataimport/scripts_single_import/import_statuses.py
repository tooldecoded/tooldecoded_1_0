        ...
        if action == 'delete':
            if name:
                try:
                    ...
                    print(f"Row {i+1}: Status '{name}' not found")
            else:
            ...
            if name:
                try:
                    ...
                    print(f"Row {i+1}: Status '{name}' not found for update")
            else:
            ...
            if name:
                try:
                    # Check if exists
                    status = Statuses.objects.get(name=name)
                    print(f"Status {name} already exists, skipping create")
                except Statuses.DoesNotExist:
                    # Create it
